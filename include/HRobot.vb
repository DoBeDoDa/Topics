...
Module HRobot
    ...
    End Function
    <DllImport("HRSDK.dll")> Public Function spline(robot As Integer, mode As Integer, smooth_value As Double) As Integer
    End Function   
	<DllImport("HRSDK.dll")> Public Function set_spl(robot As Integer, coor_type As Integer, p() As Double) As Integer
    End Function   
	<DllImport("HRSDK.dll")> Public Function clear_spl(robot As Integer) As Integer
    End Function   
    ...
    End Function
    <DllImport("HRSDK.dll")> Public Function get_current_ext_rpm(robot As Integer, rpm() As Double) As Integer
    End Function
    <DllImport("HRSDK.dll")> Public Function get_current_tcp_speed(robot As Integer, speed() As Double) As Integer
    End Function	
    ...
    End Function
    <DllImport("HRSDK.dll")> Public Function get_hrss_sdkver(robot As Integer, ByRef large_verAs Integer, ByRef small_ver As Integer, ByRef revision As Integer) As Integer
    End Function
    <DllImport("HRSDK.dll")> Public Function get_hrsdk_sdkver(ByRef large_verAs Integer, ByRef small_ver As Integer, ByRef revision As Integer) As Integer
    End Function
