...
Whenever any file modifications are completed, the agent must commit the changes locally with a descriptive commit message and don't push them to the configured remote GitHub repository (`main` branch).
