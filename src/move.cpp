...
int main() {
    ...
    double CAM_JOINT[6] = {0.0, -32.319, 51.653, 0.0, -18.813, -90.0}; 
    double prehit_joint[6] = {-126.689, 473.610, -180, -179, -2, 113.35};
    double hit_joint[6] = {-126.689, 473.610, -220, -179, -2, 113.35};

    cout << "[動作] 發送移動指令..." << endl;
    
    //ptp_pos(device_id, 1, prehit_joint);
    //ptp_pos(device_id, 1, hit_joint);
